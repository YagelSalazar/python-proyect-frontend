...
export const LoginForm = () => {
    return (
        <div className="container col-5 shadow" style={{ paddingBottom: "30px", marginTop: "40px",paddingTop: "15px" }}>
            ...
            <div className="row d-flex justify-content-center">
                <form style={{ width: "80%" }}>
                    <div className="form-group">
                        <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Introduzca el correo electónico" aria-describedby="emailHelp" />
                    </div>
            ...
            <div className="row d-flex justify-content-center" style={{ borderBottom: "solid 1px #7C7E83" }}>
                <button type="button" class="btn btn-light shadow-sm" style={{ fontWeight: "bold", width: "80%", marginBottom: "20px" }}>Continuar con Google</button>
                <button type="button" class="btn btn-light shadow-sm" style={{ fontWeight: "bold", width: "80%", marginBottom: "20px" }}>Continuar con Microsoft</button>
                <button type="button" class="btn btn-light shadow-sm" style={{ fontWeight: "bold", width: "80%", marginBottom: "20px" }}>Continuar con Apple</button>
